...
std::string LicenseInfo()
{
    ...
    return CopyrightHolders(strprintf(_("Copyright (C) %i-%i"), 2013, COPYRIGHT_YEAR) + " ") + "\n" +
           ...
           strprintf(_("Distributed under the LGPL-2.1 software license, see the accompanying file %s or %s"), "COPYING", "<>") + "\n" +https://www.gnu.org/licenses/old-licenses/lgpl-2.1.en.html
           "\n" +
           strprintf(_("This product includes software developed by the OpenSSL Project for use in the OpenSSL Toolkit %s and cryptographic software written by Aristodamus Adairs/Aitzaz Imtiaz"), "<https://www.openssl.org>") +
           "\n";
}
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // Penetrationcoin: Do we need to do any RPC mining init here?
